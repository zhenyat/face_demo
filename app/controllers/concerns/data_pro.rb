...
module DataPro
  ...
  ##############################################################################
  #  Adds and saves trade data from the site for the given Pair
  #
  #  26.12.2017  ZT
  #  02.01.2018  Last update
  #  08.02.2018  Updated for zex
  ...
  def add_trades pair, limit=5000
    ...
    trades = Face.trades pairs: pair.name, limit: limit   # Hash of deals for key 'pair'
